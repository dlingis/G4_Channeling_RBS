...
XWrapperDiscreteProcess(const G4String&, G4VDiscreteProcess* toRegister)
...
void XWrapperDiscreteProcess::RegisterProcess(G4VDiscreteProcess* toRegister, G4int flag, G4int region){
	fRegisteredProcess = toRegister;
...
G4bool XWrapperDiscreteProcess::
StorePhysicsTable(const G4ParticleDefinition* aParticleDefinition, const G4String& aString, G4bool aBool){
...
G4bool XWrapperDiscreteProcess::
RetrievePhysicsTable(const G4ParticleDefinition* aParticleDefinition, const G4String& aString, G4bool aBool){
