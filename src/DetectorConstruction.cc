  ...
  //if(fCrystalAmorphous[0])
	...
	if(fCrystalAmorphous[0]) {
      //crystalLogic_amo = new G4LogicalVolume (crystalSolid, mat[0], "crystal.logic_amo"); // new
   		physAbsor = new G4PVPlacement(rot, //buvo 0
                      G4ThreeVector(),
                      crystalLogic_amo,
                      "crystal.physic_amo",
                      worldLogic,
    ...
    crystalLogic2_amo = new G4LogicalVolume (crystalSolid2, mat[1], "crystal2.logic_amo");
    if(fCrystalAmorphous[0]) {
   		physAbsor2 = new G4PVPlacement(0, //buvo 0
                      position[0],
                      crystalLogic2_amo,
                      "crystal2.physic_amo",
                      crystalLogic_amo,
    ...
    if(fCrystalAmorphous[0]) {
   		physAbsor3 = new G4PVPlacement(0, //buvo 0
                      position[1],
                      crystalLogic3_amo,
                      "crystal3.physic_amo",
                      crystalLogic_amo,
    ...
    if(fCrystalAmorphous[0]) {
   		physAbsor4 = new G4PVPlacement(0, //buvo 0
                      position[2],
                      crystalLogic4_amo,
                      "crystal4.physic_amo",
                      crystalLogic_amo,
    ...
    if(fCrystalAmorphous[0]) {
   		physAbsor5 = new G4PVPlacement(0, //buvo 0
                      position[3],
                      crystalLogic5_amo,
                      "crystal5.physic_amo",
                      crystalLogic_amo,
...
void DetectorConstruction::ConstructSDandField()
{
  ...
  if(use_xs_transformation) {
    ...
    testMany->AttachTo(crystalLogic4);
    testMany->AttachTo(crystalLogic5);
  }
}
