  ...
  while( (*myParticleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      XWrapperContinuousDiscreteProcess *ionIoni_wrapper =
            new XWrapperContinuousDiscreteProcess("Alpha_Ionization");
      ...
      XWrapperDiscreteProcess *ecs_wrapper =
            new XWrapperDiscreteProcess("Alpha_CoulombScattering");
...
*/
  ...
  // chann
  XWrapperContinuousDiscreteProcess *ionIoni_wrapper =
        new XWrapperContinuousDiscreteProcess("Ion_Ionization");
  ionIoni_wrapper->RegisterProcess(ionIonis,-1);		// bandymas 
  ph->RegisterProcess(ionIoni_wrapper, particle);
  ...
  //ph->RegisterProcess(ecs, particle);
  XWrapperDiscreteProcess *ecs_wrapper =
        new XWrapperDiscreteProcess("Ion_CoulombScattering");
  ecs_wrapper->RegisterProcess(ecs,1,1);
  ecs_wrapper->RegisterProcess(ecs,0,2);	// perkeliau cia, buvo ecs,0,2 
  ph->RegisterProcess(ecs_wrapper, particle);
  ...
  pmanager->AddProcess(new G4StepLimiter,       -1,-1,3); 
      ...
      ph->RegisterProcess(kss, particle);
            ...
            new XWrapperContinuousDiscreteProcess("prot_Ionization");
            ...
            new XWrapperContinuousDiscreteProcess("prot_Bremsstrahlung");
            ...
            new XWrapperContinuousDiscreteProcess("prot_PairProduction");
            ...
            XWrapperDiscreteProcess *ecs_wrapper =
                new XWrapperDiscreteProcess("prot_CoulombScattering");
            ecs_wrapper->RegisterProcess(ecs,1,1);
            ecs_wrapper->RegisterProcess(ecs,0,2);	// bandymas pakeisti is 2 i 1
            ph->RegisterProcess(ecs_wrapper, particle);
      ...
      pmanager->AddProcess(new G4StepLimiter,-1,-1,3); 
            ...
            XWrapperContinuousDiscreteProcess *hIoni_wrapper =
            new XWrapperContinuousDiscreteProcess("deuteron_Ionization");
            hIoni_wrapper->RegisterProcess(hIoni,-1);
            ph->RegisterProcess(hIoni_wrapper, particle);
            ...
            XWrapperDiscreteProcess *ecs_wrapper =
                new XWrapperDiscreteProcess("deuteron_CoulombScattering");
            ecs_wrapper->RegisterProcess(ecs,1,1);
            ecs_wrapper->RegisterProcess(ecs,0,2);	// bandymas pakeisti is 2 i 1
            ph->RegisterProcess(ecs_wrapper, particle);
/*
